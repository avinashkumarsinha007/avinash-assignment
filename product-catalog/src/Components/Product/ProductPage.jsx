...
export const ProductPage = ({ carsData,car }) => {
  
     var items = [
    {
      img:`https://s3-us-west-2.amazonaws.com/revvselfdrivecar/Open/Hatchback_new/Maruti_Alto800.jpg`
    },
    {
      img:`https://s3-us-west-2.amazonaws.com/revvselfdrivecar/Open/Hatchback_new/Maruti_Alto800.jpg`
      },
  ...
  return (
    <>
      ...
      <div style={{marginTop:"-28.5%",position:"static"}}>
        <Product car={car} carsData={carsData}/>
      </div>
    </>
  );
};
