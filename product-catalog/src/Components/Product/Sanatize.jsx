        ...
        <>
            <div style={{ backgroundImage: "linear-gradient(270deg,#1caba2 25%,#1c7fab)", height: "94vh" }}>
                ...
                <div style={{marginTop:50}}> 
                        <iframe  width="560" height="340" style={{borderRadius:20}} src="https://www.youtube.com/embed/3KJI1WZGDrg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    </div>
            </div>
        </>
